...
env.roledefs = {
    'hostsDev': ['dev1', 'dev2'],
    'hostsSTG': ['fabrique@beermuseum.fabriquehq.nl', ],
    'hostsPRD': ['fabrique@ma.fabriquehq.nl', ],
    }

STAGING_LOCATION = '/var/www/beermuseum'
PRODUCTION_LOCATION = '/var/www/beermuseum'
MAIN_APP = 'oedipus'
STAGING_WSGI = 'oedipus/wsgi.py'
...
def deploy_stg():
    with cd(STAGING_LOCATION):
        ...
        run("source ../beermuseum-env/bin/activate && python ./manage.py migrate")
